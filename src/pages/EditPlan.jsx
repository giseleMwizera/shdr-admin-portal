...
const EditPlan = () => {
  ...
  const onSubmit = (data) => {
    setLoading(true);
    api
      .patch(`/projects/${project._id}`, updatedProject)
      .then((res) => {
        setLoading(false);
        window.history.back();
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="my-2">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  <input
                    ...
                    placeholder={
                      project.livingRooms ? project.livingRooms : "Living Rooms"
                    }
                  ...
                  <input
                    ...
                    className="px-4 py-2 border-2 outline-none rounded-lg "
                    placeholder={
                      project.washRooms ? project.washRooms : "Wash Rooms"
                    }
                  ...
                  <input
                    ...
                    className="px-4 py-2 border-2 outline-none rounded-lg "
                    placeholder={
                      project.bedRooms ? project.bedRooms : "Bed Rooms"
                    }
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 lg:gric-cols-4 gap-4">
                  {project?.images.map((img, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="relative p-4 rounded-md border-gray-700 border-2 h-[350px]"
                      >
              ...
              <div className="flex gap-2 items-center w-[50%]">
                <button
                  ...
                  className="px-4 py-2 rounded-md border-2 w-[50%]"
                >
                  Cancel
                </button>
                {loading ? (
