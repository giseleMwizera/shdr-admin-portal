...
const CreatePlan = () => {
	...
	const renderImageInputs = () => {
        ...
        <div className="w-full my-2">
          <input
            ...
            type="file"
            accept="image/*"
            className="px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[50%] bg-[#E2DDDD]"
    ...
    <div className="w-full h-full overflow-y-auto overflow-x-hidden p-5">
      <div className="p-3 my-2">
        <TopBar title="Create  plan" />
      </div>
      <div className="pl-2 pt-8 sm:p-8 ">
        <button
          onClick={() => window.history.back()}
          className="px-4 py-4 flex gap-2 items-center text-[#555555]"
        >
          <svg
        ...
        <div className="my-2 flex justify-center text-sm ml-[-20px]">
          <form
          ...
          >
            <div className="my-8">
              <p className="my-4">Enter client Name</p>
              <input
                type="text"
                className="px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[50%]"
                {...register("name")}
              />
              <p className="text-red-500">{errors.name?.message}</p>
            </div>
            <div className="my-8">
              <p className="my-4">Choose Category of House Plan</p>
              <select
                className="px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[50%] bg-white"
                {...register("category")}
              >
            ...
            <div className="my-8 ">
              <p className="my-4">Enter number of Floors</p>
              <input
                type="number"
                className="px-4 py-2 border-2 outline-none  rounded-lg w-[100%] sm:w-[50%]"
            ...
            <div className="my-8 ">
              <p className="my-4">Enter number of Rooms (Optional)</p>
              <div className="flex flex-col sm:flex-row gap-2 w-[100%] sm:w-[50%] text-sm ">
                <input
                  type="number"
                  className="px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[33%]"
            ...
            <div className="my-8">
              <p className="my-4">Enter plan Price in (USD)</p>
              <input
                type="text"
                className="px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[50%]"
                {...register("planPrice")}
            ...
            <div className="my-8">
              <p className="my-4">Enter plan Description</p>
              <textarea
                className="px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[50%]"
            ...
            <div className="my-8">
              <p className="my-4">
                Upload visual elements: <span>{"(<10mb)"}</span>{" "}
              </p>
              ...
              <div className="flex flex-col gap-1 ">
                ...
                <p className="my-4">Project Video</p>
                <input
                  type="file"
                  accept="video/*"
                  className=" px-4 py-2 border-2 outline-none rounded-lg w-[100%] sm:w-[50%] bg-[#E2DDDD]"
                  onChange={handleVid}
                />
                <p className="my-4">Project Documents</p>
            ...
            {loading ? (
              <button className="w-[100%] sm:w-[50%] bg-[#005DFF]  text-white rounded-lg px-4 py-2 my-2 cursor-pointer outline-none">
              ...
              <input
                type="submit"
                value={"Create"}
                className="w-[100%] sm:w-[50%] px-4 py-2 my-8 outline-none rounded-lg bg-[#005DFF] text-white cursor-pointer transition duration-300 ease-in-out hover:bg-[#003ccc]"
              />
            )}
          </form>
        </div>
